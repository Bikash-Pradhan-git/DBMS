...
namespace WebApplication2.Controllers
{
    public class BookingController : Controller
    {
        ...
        //        if (MovieController.ll[i].Id == b.ShowtimeId  )
        //        {
        //            ticket = MovieController.ll[i].Show.AvailableSeats;
        //            if (MovieController.ll[i].Show.AvailableSeats - b.NumberOfSeats >= 0)
        //            {
        ...
        //    return Content("Hello only "+ticket+" is available !");
        //}
